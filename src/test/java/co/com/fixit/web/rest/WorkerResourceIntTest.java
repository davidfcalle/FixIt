...
import co.com.fixit.repository.WorkerRepository;
...
public class WorkerResourceIntTest {
    ...
    private static final String DEFAULT_RH = "AAAAAAAAAA";
    private static final String UPDATED_RH = "BBBBBBBBBB";
    ...
    public void createWorker() throws Exception {
        ...
        assertThat(testWorker.getDocumentId()).isEqualTo(DEFAULT_DOCUMENT_ID);
        assertThat(testWorker.getPhone()).isEqualTo(DEFAULT_PHONE);
        assertThat(testWorker.getRh()).isEqualTo(DEFAULT_RH);
    }
    ...
    @Test
    @Transactional
    public void checkRhIsRequired() throws Exception {
        int databaseSizeBeforeTest = workerRepository.findAll().size();
        // set the field null
        worker.setRh(null);
    ...
    public void getAllWorkers() throws Exception {
        ...
        restWorkerMockMvc.perform(get("/api/workers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].rh").value(hasItem(DEFAULT_RH.toString())));
    }
    ...
    public void getWorker() throws Exception {
        ...
        restWorkerMockMvc.perform(get("/api/workers/{id}", worker.getId()))
            ...
            .andExpect(jsonPath("$.rh").value(DEFAULT_RH.toString()));
    }
    ...
    public void updateWorker() throws Exception {
        ...
        Worker testWorker = workerList.get(workerList.size() - 1);
        assertThat(testWorker.getDocumentId()).isEqualTo(UPDATED_DOCUMENT_ID);
        assertThat(testWorker.getPhone()).isEqualTo(UPDATED_PHONE);
        assertThat(testWorker.getRh()).isEqualTo(UPDATED_RH);
    }
